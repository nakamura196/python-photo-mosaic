...
import glob
files = glob.glob("/Users/nakamura/git/sim_utda/backend/output/thumbs/64px/*.jpg")


create_mosaic("/Users/nakamura/git/keras2/examples/style/pic/aka.jpg", "aaa2.jpg", tile_ratio=1920 /
              800, tile_width=75, enlargement=3, reuse=False, color_mode='RGB', tile_paths=files, shuffle_first=30)
